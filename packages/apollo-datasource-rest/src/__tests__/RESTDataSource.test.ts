import { fetch, URL } from './__mocks__/apollo-server-env';
...
describe('RESTDataSource', () => {
  ...
  describe('constructing requests', () => {
    ...
    it('allows computing a dynamic base URL', async () => {
      // FIXME this test appears to test something illegal in TS4
      ...
      // should we just remove it? Note that it's documented in docs and readme;
      // search for `get baseURL`
